...
public class CommonHelper {
  ...
  public static<T, D> D transformOrElseNull(
      T data, Function<T, D> transformationFunc) {
    return transformOrElseGet(Optional.ofNullable(data), transformationFunc, ()-> null);
  }

  public static<T, D> D transformOrElse(
      T data, Function<T, D> transformationFunc, Supplier<D> fallbackValue) {
